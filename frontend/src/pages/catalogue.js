...
export const filterToggleStyle = {
  display: 'flex',
  alignItems: 'center',
...
export const categoryButtonsStyle = {
  display: 'flex',
  flexWrap: 'wrap',
  gap: '0.5rem',
};
...
export const activeCategoryStyle = {
  backgroundColor: '#00AEBB',
  color: '#fff',
  borderColor: '#00AEBB',
};
...
export const gameIconStyle = {
  fontSize: '3rem',
  color: '#adb5bd',
};

export const discountBadgeStyle = {
  position: 'absolute',
  top: '1rem',
  left: '1rem',
